package com.example.jwt.security.v2;

import com.example.jwt.security.v2.configuration.EnableJwtSecurity;
import com.example.jwt.security.v2.model.Role;
...
public class JwtSecurityV2Application implements CommandLineRunner {

    @Autowired
    UserService userService;

    public static void main(String[] args) {
        SpringApplication.run(JwtSecurityV2Application.class, args);
    }
