...
import com.example.jwt.security.v7.configuration.MyMethodSecurityConfig;
...
public class SecureEnabledController {
     ...
     *
     * {@link MyMethodSecurityConfig} accessDecisionManager add new RoleVoter with prefix empty string.
     */
