...
import com.example.jwt.security.v6.JwtSecurityV6Application;
...
@SpringBootTest(classes = {JwtSecurityV6Application.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
